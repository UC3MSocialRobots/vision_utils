...
int main(int argc, char* argv[]) {
    ...
    std::ofstream outfile("Output/example-007.data");
    std::ofstream outfile_rms("Output/example-007-rms.data");
    double rms= 0.0;
    ...
    std::cout << " Outputs are saved in Output/example-007*.data " << std::endl;
