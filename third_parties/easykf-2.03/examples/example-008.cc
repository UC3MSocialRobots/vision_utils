...
int main(int argc, char* argv[]) {
    ...
    std::ofstream outfile("Output/example-008.data");
    std::ofstream outfile_rms("Output/example-008-rms.data");
    double rms= 0.0;
    ...
    std::cout << " Outputs are saved in Output/example-008*.data " << std::endl;
