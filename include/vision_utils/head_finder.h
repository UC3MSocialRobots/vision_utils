...
#include <vision_utils/draw_ellipses.h>
...
public:
  ...
  bool find(const cv::Mat1b & user_mask,
    ...
    _fitted_ellipse = vision_utils::three_pts2ellipse
    ...
    vision_utils::ellipse_axes(_fitted_ellipse, _ellipse_all_axes[0], _ellipse_all_axes[1],
