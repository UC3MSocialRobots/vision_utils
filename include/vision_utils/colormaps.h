...
//! \return [1 0.25]:red -> 0:green
template<class Color4_255>
Color4_255 ratio2red_green_quarter_(const double & ratio) {
  return ratio2red_green_<Color4_255>( 4. * ratio );
}

//! template specialization for cv::Scalar
RatioColormap ratio2red_green_quarter = &ratio2red_green_quarter_<cv::Scalar>;
